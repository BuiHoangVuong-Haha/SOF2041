...
INSERT INTO [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen], [VaiTro], [GioiTinh]) VALUES (N'Luong', N'songluong', N'Nguyễn Quang Long', 0, 'Nam')

INSERT INTO [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen], [VaiTro], [GioiTinh]) 
VALUES (N'HaMy', N'ha123', N'Nguyễn Hà My', 1, N'Nữ');

INSERT INTO [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen], [VaiTro], [GioiTinh]) 
VALUES (N'MinhTuan', N'mt456', N'Phạm Minh Tuấn', 0, N'Nam');

INSERT INTO [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen], [VaiTro], [GioiTinh]) 
VALUES (N'TranAnh', N'ta789', N'Trần Thị Anh', 1, N'Nữ');

INSERT INTO [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen], [VaiTro], [GioiTinh]) 
VALUES (N'DucThang', N'dt321', N'Hoàng Đức Thắng', 0, N'Nam');

INSERT INTO [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen], [VaiTro], [GioiTinh]) 
VALUES (N'BaoTram', N'bt654', N'Lê Bảo Trâm', 1, N'Nữ');

INSERT INTO [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen], [VaiTro], [GioiTinh]) 
VALUES (N'LeHoang', N'bt554', N'Lê Hoàng', 1, N'Khác');

INSERT INTO [dbo].[NhanVien] ([MaNV], [MatKhau], [HoTen], [VaiTro], [GioiTinh]) 
VALUES 
(N'NguyenVanA', N'abc123', N'Nguyễn Văn A', 1, N'Khác'),
(N'TranThiB', N'xyz789', N'Trần Thị B', 0, N'Khác'),
(N'PhamMinhC', N'qwe456', N'Phạm Minh C', 1, N'Khác'),
(N'LeHoangD', N'asd321', N'Lê Hoàng D', 0, N'Khác'),
(N'HoangQuocE', N'zxc987', N'Hoàng Quốc E', 1, N'Khác');
